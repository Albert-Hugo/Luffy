 ...
 */
@Slf4j
public class LuffyAutoConfig implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware {
    private ResourceLoader resourceLoader;

    private Environment environment;
    private Map<String, Set<String>> rolesUrlTable = new HashMap<>(20);


    @Override
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        System.out.println("regiterring bean definition by import only");
        ...
        SecurityManager.init(rolesUrlTable);

        log.info("role permission table is {}", rolesUrlTable.toString());
    }
